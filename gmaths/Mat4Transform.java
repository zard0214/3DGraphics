...
public final class Mat4Transform {   // row column formulation
    ...
    /**
     * Creates a view matrix corresponding to a core.camera at a given position, looking at a particular target point, with a specified worldup direction.
     ...
     *
     * @param from    The core.camera postion.
     * @param to      The target that the core.camera is looking at.
